...
export const DATA_SOURCE_REGISTRY: DataSourceDefinition[] = [
  ...
  },
  {
    ...
    crawlable: true,
    updateFrequency: '按需刷新',
    fields: ['商品名', '品牌', '类目', '价格', '评分', '库存'],
    queryPatterns: [/商品|产品|价格|品牌|类目|选品|竞品|销售|销量|库存|评价|评分/],
    summary: '默认接入 DummyJSON 公开商品样例 API，用于补充商品字段、价格和评分参考。',
    usageNote: '该来源是公开样例数据，不代表真实平台销售表现。'
  },
  {
